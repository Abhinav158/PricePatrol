              ...
              <div className='flex gap-3'>
                <div className='product-stars'>
                  <Image 
                    ...
                    height={16}
                  />
                  <p className='text-sm text-primary-orange font-semibold'>{product.stars || 30}</p>
                ...
                <div className='product-reviews'>
                  <Image 
                    ...
                    height={16}
                  />
                  <p className='text-sm text-secondary font-semibold'>{product.reviewsCount || 100} Reviews</p>
                </div>
              </div>
              
              <p className='text-sm text-black opacity-50'><span className='text-primary-green font-semibold'>93%</span> of buyers have recommended this</p>
